      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex relative">
          ...
          <div className="relative flex-1 bg-black bg-opacity-50 rounded-lg p-8">
            <h1 className="text-5xl md:text-6xl lg:text-7xl mt-16 font-bold text-white max-w-4xl" style={{ fontFamily: "'Roboto', sans-serif" }}>
              Empower Your AI App Creation Journey
            </h1>
            <p
              className="mt-10 text-lg text-gray-400 max-w-2xl"
              style={{ fontFamily: "'Roboto', sans-serif" }}
            >
              AI App Builder empowers users to create, simulate, and deploy AI-powered apps
              effortlessly. Our intuitive drag-and-drop tool enables seamless custom app
              development, performance optimization, and multi-platform deployment within
