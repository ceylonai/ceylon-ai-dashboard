...
import { AIAgent } from "@/type/flow";

interface AgentSelectorDialogProps {
  open: boolean;
  onCloseAction: () => void; // Renamed to conform to naming convention
  onSelectAgentAction: (agent: AIAgent) => void; // Renamed to conform to naming convention
}
...
export function AgentSelectorDialog({
                                      open,
                                      onCloseAction, // Updated usage
                                      onSelectAgentAction, // Updated usage
            ...
            <div className="grid gap-4">
              {availableAgents.map((agent) => (
                  <Button
                      ...
                      onClick={() => onSelectAgentAction(agent)}
                  >
